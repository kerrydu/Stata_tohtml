...
capture log close
log using "$logs/example_clean.log", replace text
...
capture log close
tohtml "$logs/example_clean.log", ///
    md("$logs/example_clean.md") ///
    html("$logs/example_clean.html") ///
    embed clean mathjax replace
